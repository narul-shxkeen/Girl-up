    ...
    return (
        <div className='h-full'>
            <div className="flex flex-col w-[100%] rounded-[65px] z-20">
                ...
                <div className="w-full sm:w-3/4 py-11 flex justify-center sm:justify-start">        
                <Link to="first"><button className='flex flex-col w-[250px] gap-3 bg-[#D9D9D9] justify-center items-center min-w-40' onClick={handleClick}>
