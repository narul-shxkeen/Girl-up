...
const Project = () => {
    ...
    const ProjectCard = ({ link, image, altText, title, handleClick }) => {
        return (
            <div className="w-[80vw] sm:w-3/4 py-11 flex justify-center">
                <Link to={link}>
    ...
    return (
        <div className='h-full'>
            <div className="flex flex-col w-[100%] rounded-[65px] z-20 items-center">
                ...
                <div className='flex flex-col sm:grid sm:grid-cols-3 items-center justify-items-center w-[80vw] h-auto sm:px-5 sm:gap-3'>
