...
function Template(){
    ...
    <div className="bg-[#E3D5CA] flex flex-col items-center h-[100vh] overflow-y-scroll">
        <h1 className="sen-regular mt-3 text-7xl mb-3">About Us</h1>
        <div className="relative h-[150vh]">
            <img src="/images/home2.png" className="w-[100vw] h-auto z-10 object-cover"/>
            <div className="bg-[#D9D9D9] rounded-[65px] z-30 mx-40 mb-40 my-12 absolute top-[10px] px-5 py-12  ">
