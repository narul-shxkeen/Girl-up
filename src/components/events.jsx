...
function EventMain(){
    ...
    <div className="bg-[#E3D5CA] h-[100vh] overflow-y-scroll">
        ...
        <p className="font-bold text-[#502E2A] drop-shadow-[0_4px_4px_rgba(0, 0, 0, 0.25)] sen-regular mt-5 sm:mt-3 text-5xl mb-1 sm:mb-3 text-center"> Upcoming Events: </p>
...
<EventCard eventName="Third Event: Self Help Groups" date = "" link= "/third"/>
        ...
        <p className="font-bold text-[#502E2A] drop-shadow-[0_4px_4px_rgba(0, 0, 0, 0.25)] sen-regular mt-5 sm:mt-3 text-5xl mb-1 sm:mb-3 text-center"> Past Events: </p>
       <div className="grid md:grid-cols-2 gap-4 justify-items-center px-8 py-20">
