...
import Pratishtha from "./team/Pratishtha_Chaudhary.png";
import Gauri from "./team/Gauri_Deshpande.png";
import Saina from "./team/Saina_Kalla.jpg";
import Ishita from "./team/Ishita-Anand.png";
import Aditi from "./team/Aditi_Kedia.jpg";
import Noyonika from "./team/Noyonika_Dutta.webp";
import Vriddhi from "./team/Vriddhi_Baid.png";
import Tia from "./team/Tia_Mohanani.png";
...
import Karunya from "./team/Karunya_Singh_Bisht.png";
...
function Socialmedia(){
    ...
    <div className="bg-[#E3D5CA] h-[100vh] overflow-y-scroll">
        <h1 className="sen-regular mt-5 sm:mt-3 text-7xl mb-1 sm:mb-3 text-center"> Social Media & Content Team </h1>
        ...
        <TeamCard name="Pratishtha Chaudhary" batch="UG25" img={Pratishtha} object="object-top"/>
        ...
        <TeamCard name="Tia Mohanani" batch="UG2023" img={Tia} object="object-top"/>
        ...
        <TeamCard name="Karunya Singh Bisht" batch="UG2023" img={Karunya} object="object-top"/>
        </div>
        </div></div>
    )    
}
