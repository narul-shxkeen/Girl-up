...
import Kunj from "./team/Kunj_Agarwal.png";
...
import Sakshi from "./team/Sakshi-Bhagat.png";
...
function Externals(){
    ...
    <div className="bg-[#E3D5CA] h-[100vh] overflow-y-scroll">
        ...
        <TeamCard name="Kunj Agarwal" batch="UG2023" img={Kunj} object="object-top"/>
        ...
        <TeamCard name="Sakshi Bhagat" batch="UG2023" img={Sakshi} object="object-top"/>
        </div>
        </div></div>
    )    
}
