...
function Event(){
    const imageUrls = [
        "/images/first_project/1.png",
        "/images/first_project/2.png",
        "/images/first_project/3.png",
    ];

    const sessionImages=[
        "images/first_project/budgeting/1.jpeg",
        "images/first_project/budgeting/2.jpeg",
        "images/first_project/budgeting/3.jpeg",
        "images/first_project/budgeting/4.jpeg",
    ]
...
<FirstSession imageUrls={sessionImages}/>
</div>
        </div>
    </div>
    </div>
